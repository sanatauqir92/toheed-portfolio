      ...
      {open && <Modal isOpen={open} onClose={() => setOpen(false)} imageUrl={`/stills/lg_${image}`} altText="Enlarged still" />}
        ...
        <div className="mt-8 space-y-4">
          {[
            {
              title: 'Narrative',
              content: 'Narrative editing is the art of shaping story, emotion, and rhythm. It involves collaboration, creativity, and technical skill to bring a director’s vision to life.',
            },
            {
              title: 'Music Video',
              content: 'Utilizing DaVinci Resolve, Premiere Pro, and After Effects, the workflow is streamlined for efficiency and creative flexibility. Cloud collaboration and AI-assisted editing are integrated for futuristic results.',
            },
            {
              title: 'Just For Fun ',
              content: 'Open to new projects and creative partnerships. Reach out to discuss your narrative vision and how we can bring it to the screen together.',
            },
          ].map((accordion, idx) => (
            <Accordion key={idx} title={accordion.title}>
              <div className="flex flex-row mb-2">
                <button
                  ...
                  <Image src="/stills/lg_lovespellcake_1.jpg"             
                    width={0}
                    height={0}
                    sizes="100vw" 
                    alt="Mock 1" 
                ...
                <button
                  ...
                  <Image src="/stills/lg_lovespellcake_2.jpg"             
                    width={0}
                    height={0}
                    sizes="100vw" 
                    alt="Mock 1" 
                 ...
                 <button
                  ...
                  <Image src="/stills/lg_lovespellcake_3.jpg"             
                    width={0}
                    height={0}
                    sizes="100vw" 
                    alt="Mock 1" 
                ...
                {contentOpen && <ContentModal isOpen={contentOpen} onClose={() => setContentOpen(false)} imageUrl={`/stills/lg_${image}`} altText="Enlarged still" />}
        </div>
